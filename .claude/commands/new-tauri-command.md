...
3. **Use case** — implement free function(s) in `crates/core/src/application/<feature>/*.rs` taking `Arc<dyn Port>`. Add a unit test in `crates/core/tests/` using an in-memory fake.
