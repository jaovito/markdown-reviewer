...
export function DocumentSearchBar({
  ...
  return (
    <div className="sticky top-3 z-50 flex justify-end pointer-events-none mb-[-2.5rem] pr-6">
      <div className="pointer-events-auto flex items-center gap-1.5 rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] text-[hsl(var(--card-foreground))] p-1.5 shadow-2xl animate-in fade-in-50 slide-in-from-top-2">
        <Input
          ref={inputRef}
          type="text"
          value={query}
